...
(function () {
  ...
  var headerHTML = [
    ...
    '    <a href="' + base + 'index.html" class="site-logo" aria-label="Karaoke Wanwan - Home">',
    '      <span class="site-logo__icon" aria-hidden="true">&#127176;</span>',
    '      <span class="site-logo__text">Wanwan<span class="site-logo__sub">KARAOKE</span></span>',
    '    </a>',
  ...
  var footerHTML = [
    ...
    '        <a href="' + base + 'index.html" class="footer-brand__logo" aria-label="Karaoke Wanwan - Home">',
    '          <span class="footer-brand__logo-icon" aria-hidden="true">&#127176;</span>',
    '          <span class="footer-brand__logo-text">Wanwan KARAOKE</span>',
    '        </a>',
    ...
    '        <ul class="footer-col__links" role="list">',
    '          <li><span class="footer-col__link" data-i18n="footer.address">Wanwan Co., Ltd.</span></li>',
    '        </ul>',
    '      </div>',
    '    </div>',
    '    <div class="footer-bottom">',
    '      <span data-i18n="footer.copyright">&copy; 2024 Karaoke Wanwan. All rights reserved.</span>',
